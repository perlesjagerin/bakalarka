...
\thanks{Rád bych poděkoval vedoucímu práce Mgr. Jiřímu Zacpalovi, Ph.D. za cenné připomínky a konzultace během zpracování této práce. Zvláštní poděkování patří mé rodině za trpělivost a podporu v průběhu celého studia.}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\textwidth]{graphics/reservation-flow.png}
...
\begin{sidewaysfigure}
    \centering
    \includegraphics[width=0.95\textheight]{graphics/class-diagram.png}
